...
2. [meimei-repo-boundaries.v1.md](../architecture/meimei-repo-boundaries.v1.md) — what may depend on what.  
3. [meimei-kernel-code-audit.v1.md](../architecture/meimei-kernel-code-audit.v1.md) — evidence and inventory.  
4. [meimei-kernel-handbook.v1.md](meimei-kernel-handbook.v1.md) — operational and integration detail.  
5. [inference-route.v1.md](../api/inference-route.v1.md) — request/response truth for the inference seam.  
6. [ai-runtime-audit.md](../compliance/ai-runtime-audit.md) — full runtime map when messaging or scoping features.
