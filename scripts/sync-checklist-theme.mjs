 ...
 *
 * Usage:
 *   CHECKLIST_WEB_APP=/path/to/checklist/apps/consultant-followup-web node scripts/sync-checklist-theme.mjs
 *   CHECKLIST_WEB_APP=... node scripts/sync-checklist-theme.mjs --patch-layout
 */
...
const srcCss = path.join(repoRoot, "integrations/checklist-web/meimei-checklist-theme.css");
