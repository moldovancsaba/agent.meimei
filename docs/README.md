...
| [DELIVERY-phase-0-2026-03-29.v1.md](releases/DELIVERY-phase-0-2026-03-29.v1.md) | Phase 0 / Phase B delivery (`0.8.1`–`0.8.5` — boundaries, Checklist stack, platform + tool surface pages, monitor feed) |
