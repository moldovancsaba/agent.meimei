...
| 2026-03-29 | **MM-KERNEL-602 / 604:** [`packages/daily-briefing/`](../../packages/daily-briefing/meimei.app.json) pilot; generated [`functions/registry.v1.json`](../../functions/registry.v1.json) (`kernel:registry:generate` / `generate-check`); [`kernel-apps.v1.md`](../operations/kernel-apps.v1.md) + program doc status rows. |
