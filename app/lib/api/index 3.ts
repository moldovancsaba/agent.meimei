/**
 * Client-Side API Client for ChangeMass
 * 
 * Central hub for client-safe API integrations including:
 * - ImgBB CDN for image storage
 * - LightX Upload API for secure image hosting
 * 
 * Note: Virtual try-on is now handled server-side only with Google Cloud Imagen
...
// NOTE: Vertex AI exports are in ./server.ts - import from there in API routes only
...
// NOTE: Vertex AI types and workflow functions are in ./server.ts - import from there in API routes only

// ============================================================================
// CLIENT-SIDE WORKFLOW FUNCTIONS
// ============================================================================
